...
class MakananAdapter(private val restaurantList: List<Makanan>, private val itemClickListener: OnItemClickListener) : RecyclerView.Adapter<MakananAdapter.RestaurantViewHolder>() {

    interface OnItemClickListener {
        fun onItemClick(restaurant: Makanan)
    }
